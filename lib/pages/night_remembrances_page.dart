...
class NightRemembrancesPage extends StatefulWidget {
   NightRemembrancesPage({super.key});

  @override
  State<NightRemembrancesPage> createState() => _NightRemembrancesPageState();
}

class _NightRemembrancesPageState extends State<NightRemembrancesPage> {
  ...
  Future<void> storeRemembrances(List<Remembrance> remembrances) async {
    ...
    await prefs.setStringList('remembrancesKeyNight', remembrancesJsonList);
  }

  // Function to retrieve the list of Remembrances
  Future<List<Remembrance>> retrieveRemembrances() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String>? remembrancesJsonList = prefs.getStringList('remembrancesKeyNight'); 
  ...
  Future<bool> isFirstTime() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getBool('isFirstTimeNight') ?? true;
  }

  Future<void> setFirstTimeFlag() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool('isFirstTimeNight', false);
  }
    ...
    if (firstTime) {      
      setState(() {
        l_remembrance = [
          ...
          Remembrance(color: 0xffffc401, title: "مرة واحدة", content: "أمسينا و أمسى الملك لله والحمدلله, لا إله إلا الله وحده لا شريك له, له الملك وله الحمد وهو على كل شيءٍ قدير"),
          Remembrance(color: 0xff12699e, title: "مرة واحدة", content: "- يا حي يا قيوم برحمتك أستغيث أصلح لي شأني كله ولا تكلني إلى نفسي طَرْفَةَ عَيْن\n\n- اللهم بك أمسينا وبك أصبحنا وبك نموت وإليك المصير"),
          Remembrance(color: 0xff0A5C36, title: "مرة واحدة", content: "اللهم ما أمسى بي من نعمةٍ أو بأحدٍ من خلقك فمنك وحدك لا شريك لك فلك الحمد ولك الشكر"),
          ...
          Remembrance(color: 0xff62249F, title: "٣ مرة", content: "- أعوذ بكلمات الله التامات من شر ما خلق\n\n- رضيت بالله رباً وبالإسلام ديناً, وبمحمدٍ صلى الله عليه وسلم نبياً"),
          Remembrance(color: 0xff12699e, title: "٣ مرة", content: "بسم الله الذي لا يضر مع اسمه شيء, في الأرض ولا في السماء, وهو السميع العليم"),
